...
classAdapter(private val data: ArrayList<TvShowsPresentation>): RecyclerView.AdapterAdapterViewHolder>()
{
    ...
    private val movieTextView = itemView.findViewById<TextView>(R.id.movie_original_lenguage)
        ...
        fun bind(movie:TvShowsPresentation){
    ...
    fun updateMovies(movie: List<TvShowsPresentation>){
        data.clear()
        data.addAll(movies)
